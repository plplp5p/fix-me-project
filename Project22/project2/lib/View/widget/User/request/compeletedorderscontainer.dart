...
import 'package:project2/View/screen/User/requests/ratingworker.dart';

class CompeletedOrdersContainer extends StatelessWidget {
  const CompeletedOrdersContainer({super.key});

  @override
  Widget build(BuildContext context) {
    UserCompeletedOrdersController controller =
            ...
            child: Column(
              children: [
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    showdialog(
                        context, controller.userOrders[i].workerUsername!);
                  },
                  child: const Text(
                    "Rating ",
