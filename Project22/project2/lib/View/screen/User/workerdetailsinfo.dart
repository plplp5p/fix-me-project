        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    "${controller.workerModel.city} - ${controller.workerModel.street} - ${controller.workerModel.zip} ",
                    style: const TextStyle(fontSize: 16),
                  ),
                ],
              ),
            ...
            MaterialButton(
              ...
              onPressed: () {
                controller.contactWorker(controller.workerModel.userName!);
              },
              child: const Text(
                "Message",
            ...
            GetBuilder<UserWorkerDetailsInfoController>(builder: (controller) {
