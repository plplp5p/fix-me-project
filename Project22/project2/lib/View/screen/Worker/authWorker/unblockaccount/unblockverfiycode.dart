...
import 'package:project2/Controllers/Worker/authController/unblockaccount/nublockverfiycode_controller.dart';
...
class Workerverfiycodereopen extends StatelessWidget {
  const Workerverfiycodereopen({super.key});

  @override
  Widget build(BuildContext context) {
    WorkerverifycodeopenController controller =
        Get.put(WorkerverifycodeopenController());
    return Scaffold(
