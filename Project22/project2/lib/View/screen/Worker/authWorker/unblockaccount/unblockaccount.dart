...
import 'package:project2/Controllers/Worker/authController/unblockaccount/ckeckemail_controller.dart';
...
class Workeremailreopenaccount extends StatelessWidget {
  const Workeremailreopenaccount({super.key});

  @override
  Widget build(BuildContext context) { 
    WorkerreopenaccountController controller = Get.put(WorkerreopenaccountController());
    return Scaffold(
