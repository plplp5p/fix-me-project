...
import 'package:project2/Controllers/Worker/authController/workerverifycodesginin_controller.dart';
...
class WorkerVerifyCode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WorkerverifSignUpController conroller =
        Get.put(WorkerverifSignUpController());
    return Scaffold(
                ...
                children: [
                  ...
                  OtpTextField(
                    ...
                    onSubmit: (String verificationCode) {
                      conroller.goToRestPasswordWorker(verificationCode);
                    }, // end onSubmit
                  ),
                  const SizedBox(
                    height: 30,
