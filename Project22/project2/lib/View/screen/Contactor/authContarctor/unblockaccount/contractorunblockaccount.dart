...
import 'package:project2/Controllers/Contractor/authController/unblockaccont/contractorcheckemailunblock_controller.dart';
...
class Contrctorreopenaccount extends StatelessWidget {
  const Contrctorreopenaccount({super.key});

  @override
  Widget build(BuildContext context) {
    ContrctorreopenaccountController controller =
        Get.put(ContrctorreopenaccountController());
    return Scaffold(
