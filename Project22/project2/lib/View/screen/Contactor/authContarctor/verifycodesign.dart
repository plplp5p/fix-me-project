...
import 'package:project2/Controllers/Contractor/authController/verifysignup_controller.dart';
...
class ContactorVerifyCode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ContrctorVerifycodesigninController controller =Get.put(ContrctorVerifycodesigninController());
    return Scaffold(
