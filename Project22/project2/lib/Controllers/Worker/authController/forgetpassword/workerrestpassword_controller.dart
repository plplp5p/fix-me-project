...
import 'package:project2/Model/data/worker/auth/foregetpassword/workerrestpassword_data.dart';

class WorkerrestpasswordController extends GetxController {
    ...
    if (newpassword.text == repassword.text) {
      ...
      if (InquiryStatus.success == inquiryStatus) {
        if (request['status'] == "success") {
          Get.offAllNamed("WorkerSuccessRestPassword");
        } else {
